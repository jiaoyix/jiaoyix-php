...
require_once('QrCode/Exceptions/DataDoesntExistsException.php');
require_once('QrCode/Exceptions/FreeTypeLibraryMissingException.php');
require_once('QrCode/Exceptions/ImageFunctionFailedException.php');
require_once('QrCode/Exceptions/VersionTooLargeException.php');
require_once('QrCode/Exceptions/ImageSizeTooLargeException.php');
require_once('QrCode/Exceptions/ImageFunctionUnknownException.php');

use Jiaoyix\QrCode\Exceptions\DataDoesntExistsException;
use Jiaoyix\QrCode\Exceptions\FreeTypeLibraryMissingException;
use Jiaoyix\QrCode\Exceptions\ImageFunctionFailedException;
use Jiaoyix\QrCode\Exceptions\VersionTooLargeException;
use Jiaoyix\QrCode\Exceptions\ImageSizeTooLargeException;
use Jiaoyix\QrCode\Exceptions\ImageFunctionUnknownException;
...
class QrCode
{
    ...
    {
        $this->setPath(__DIR__.'/QrCode/assets/data');
        $this->setImagePath(__DIR__.'/QrCode/assets/image');
        $this->setLabelFontPath(__DIR__.'/QrCode/assets/font/opensans.ttf');
        $this->setText($text);
    }
    ...
    public function setErrorCorrection($error_correction)
    {
        if (!is_numeric($error_correction)) {
            $level_constant = 'Jiaoyix\Util\QrCode::LEVEL_'.strtoupper($error_correction);
