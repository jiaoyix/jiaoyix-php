...
class JiaoyixObject implements ArrayAccess, JsonSerializable
{
    /**
    ...
    /**
     * @return object The last response from the Jiaoyix API
     */
     ...
     * @param ApiResponse
     *
     * @return void Set the last response from the Jiaoyix API
     */
    ...
    public function &__get($k)
    {
        ...
        if (array_key_exists($k, $this->_values)) {
            ...
            $message = "Jiaoyix Notice: Undefined property of $class instance: $k. "
                    . "HINT: The $k attribute was set in the past, however. "
                    . "It was then wiped when refreshing the object "
                    . "with the result returned by Jiaoyix's API, "
            ...
            $class = get_class($this);
            error_log("Jiaoyix Notice: Undefined property of $class instance: $k");
            return $nullval;
        }
    }
     ...
     * @param array $opts
     *
     * @return JiaoyixObject The object constructed from the given values.
     */
    ...
    public function refreshFrom($values, $opts, $partial = false)
    {
        ...
        foreach ($values as $k => $v) {
            ...
            if (self::$nestedUpdatableAttributes->includes($k) && is_array($v)) {
                ...
                $this->_values[$k] = Util\Util::convertToJiaoyixObject($v, $opts);
            }
     ...
     */
    public function serializeParameters($params = array())
    {
        ...
        foreach (self::$nestedUpdatableAttributes->toArray() as $property) {
            if (isset($this->$property)) {
                if ($this->$property instanceof JiaoyixObject) {
